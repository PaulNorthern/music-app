        ...
        configure({
            generateMessage: (ctx) => {
                const messages = {
                    ...
                    alpha_spaces: `The field ${ctx.field} may only contain alphabetic chars & spaces.`,
                    email: `The field ${ctx.field} must be a valid email.`,
                    min_value: `The field ${ctx.field} is too low.`,
                    max_value: `The field ${ctx.field} is too high.`,
                    confirmed: `The field ${ctx.field} is too high.`,
                    excluded: `You are not allowed to use this field - ${ctx.field}.`,
                    country_excluded: `We do not accept users from this location.`,
                    password_mismatch: `The passwrod dont match.`,
