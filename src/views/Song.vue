        ...
        <div class="p-6">
          ...
          <vee-form
            ...
            <button
                ...
                :disabled="comments_in_submission">
              Submit
            </button>
          </vee-form>
          <!-- Sort Comments -->
...
export default {
  ...
  computed: {
    ...
    sortedComments() {
      // slice() - returned a brand-new array
  ...
  // load component after we have the data
  async beforeRouteEnter(to, from, next) {
    const docSnapshot = await songCollection
        .doc(to.params.id)
        .get();
  ...
  methods: {
    ...
    async addComment(values, {resetForm}) {
      ...
      this.comments_in_submission = false;
